...
function ShopSystem:GetItemSellPriceEnhanced(itemId, playerData)
	...
	local baseSellPrices = {
		-- Crops
		carrot = {price = 8, currency = "coins"},
		corn = {price = 725, currency = "coins"},
		strawberry = {price = 350, currency = "coins"},
		wheat = {price = 600, currency = "coins"},
		potato = {price = 40, currency = "coins"},
		cabbage = {price = 75, currency = "coins"},
		radish = {price = 140, currency = "coins"},
		broccoli = {price = 110, currency = "coins"},
		tomato = {price = 675, currency = "coins"},
		golden_fruit = {price = 100, currency = "coins"},
		glorious_sunflower = {price = 999, currency = "Robux"},

		-- Animal products
		milk = {price = 5, currency = "coins"},
