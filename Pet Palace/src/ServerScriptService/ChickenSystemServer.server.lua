...
function ChickenSystem:CreateChickenModel(chickenInstance)
	...
	if chickenModel.PrimaryPart then
		...
		local mainPart = chickenModel:FindFirstChild("Body") or 
			chickenModel:FindFirstChild("Torso") or 
			chickenModel:FindFirstChild("HumanoidRootPart") or
	...
	print("ChickenSystem: Successfully created chicken model from template")
	return chickenModel
end
