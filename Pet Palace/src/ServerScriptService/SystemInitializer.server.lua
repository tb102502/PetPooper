...
local GameCore = require(script.Parent.Core.GameCore)
local ShopSystem = require(script.Parent.Systems.ShopSystem)

-- Initialize GameCore first
local success = GameCore:Initialize()
if success then
...
if shopSuccess then
	...
	error("❌ ShopSystem initialization failed")
end

print("🐄 Cow Progression System: All systems initialized!")
