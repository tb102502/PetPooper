...
--[[
	...
	function GameCore:SetupEventHandlers()
		...
		if self.RemoteFunctions.GetShopItems then
			self.RemoteFunctions.GetShopItems.OnServerInvoke = function(player)
				...
				print("GameCore: Sending " .. #shopItemsArray .. " shop items to " .. player.Name)
				return shopItemsArray
			end
			print("✅ Connected GetShopItems function")
		end
	...
	function GameCore:Initialize()
		...
		-- ========== FIXED ORDER: Create events BEFORE loading connections ==========
		self:EnsureSellingRemoteEvents()  -- Create missing events first
		self:SetupRemoteConnections()     -- Then load all events into self.RemoteEvents
		self:SetupEventHandlers()         -- Then set up handlers
