...
function GameCore:IsPlotProtected(player, plotNumber)
	...
	-- Check if player has any roof protection
	if playerData.defense and playerData.defense.roofs then
		for roofId, roofData in pairs(playerData.defense.roofs) do
			if roofData.protection and roofData.coverage then
				-- Check if this roof covers the specific plot
				if roofData.coverage >= plotNumber or roofId == "mega_dome" then
					print("GameCore: Plot " .. plotNumber .. " protected by " .. roofId)
					return true
				end
			end
		end
	...
	-- Check if player has purchased any protection upgrades
	if playerData.upgrades then
		-- Check for mega dome protection (protects all plots)
		if playerData.upgrades.mega_dome then
			print("GameCore: Plot " .. plotNumber .. " protected by mega dome")
			return true
		end

		-- Check for plot-specific protection
		if playerData.upgrades["plot_protection_" .. plotNumber] then
			print("GameCore: Plot " .. plotNumber .. " has specific protection")
			return true
		end
	end

	-- Check purchase history for protection items
	if playerData.purchaseHistory then
		if playerData.purchaseHistory.mega_dome then
			print("GameCore: Plot " .. plotNumber .. " protected by purchased mega dome")
			return true
		end
	end

	print("GameCore: Plot " .. plotNumber .. " is NOT protected")
	return false
end
