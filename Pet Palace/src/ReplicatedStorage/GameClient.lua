...
function GameClient:HandlePlantingSpotClick(spotModel, plotModel)
	print("GameClient: Planting spot clicked - Planting mode:", self.FarmingState.isPlantingMode, "Selected seed:", self.FarmingState.selectedSeed)
	...
	if not isEmpty then
		...
		print("GameClient: Attempting to plant", selectedSeed, "in spot", spotNumber)
