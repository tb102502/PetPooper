--[[
    Clean UIManager.lua - No External Dependencies
    Place in: ReplicatedStorage/UIManager
    
    FEATURES:
    ✅ No external dependencies or requires
    ✅ Clean initialization that won't fail
    ✅ All methods properly defined
    ✅ Compatible with expandable farm system
    ✅ Works with GameClient integration
]]
...
print("UIManager: Clean module loaded successfully")

-- ========== INITIALIZATION ==========

function UIManager:Initialize()
	print("UIManager: Starting clean initialization...")
	...
	print("UIManager: Clean initialization complete!")
	return true
end
...
function UIManager:CreateMenuContainers(parent)
	...
	menuContainer.Size = UDim2.new(0.8, 0, 0.8, 0)
	menuContainer.Position = UDim2.new(0.1, 0, 0.1, 0)
...
function UIManager:CreateShopMenu()
	print("UIManager: Creating shop menu")
...
function UIManager:CreateMiningMenu()
	...
	comingSoon.Text = "⛏️ MINING SYSTEM\n\nComing Soon!\nExplore deep caves and mine valuable ores."
...
function UIManager:PopulateFarmContent(expansionFrame)
	...
	if success and playerData and playerData.farming then
		...
		if expansionLevel < 5 then
			...
			expandButton.Size = UDim2.new(0.8, 0, 0, 50)
			expandButton.Position = UDim2.new(0.1, 0, 1, -70)
			expandButton.BackgroundColor3 = Color3.fromRGB(100, 200, 100)
			expandButton.BorderSizePixel = 0
			expandButton.Text = "🌱 Expand Farm (Coming Soon)"
...
print("UIManager: ✅ Clean module ready for initialization")
