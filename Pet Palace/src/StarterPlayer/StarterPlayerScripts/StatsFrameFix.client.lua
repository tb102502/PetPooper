...
local function updateStats(playerData)
	...
	local function updateStatLabel(name, value, formatting)
	...
	updateStats("Coins", playerData.coins, function(value)
	...
	updateStats("Gems", playerData.gems)

	updateStats("Pets", playerData.pets and #playerData.pets or 0, function(value)
