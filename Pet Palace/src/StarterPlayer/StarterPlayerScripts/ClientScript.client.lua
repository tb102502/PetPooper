...
local function createSound(id, volume)
	...
	if not success then
		...
		pcall(function()
			sound.SoundId = "rbxassetid://14133663945" -- Default click sound
		end)
	end
...
local collectSound = createSound("rbxassetid://95438408815871", 0.5)
local rarePetSound = createSound("rbxassetid://6494675393", 0.7) 
