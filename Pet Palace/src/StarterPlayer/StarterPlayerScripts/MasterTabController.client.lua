...
local function createSellContent(parentFrame)
	...
	local defaultItems = {
		...
		pets = {
			{name = "Cat", value = 100, image = "6686023447", rarity = "Common"},
			{name = "Dog", value = 150, image = "6686028301", rarity = "Common"},
			{name = "Fox", value = 250, image = "6686031940", rarity = "Uncommon"},
			{name = "Owl", value = 500, image = "6686036280", rarity = "Rare"}
		}
	}
