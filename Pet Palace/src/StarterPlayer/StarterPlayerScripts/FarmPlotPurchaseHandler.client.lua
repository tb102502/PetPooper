...
local function waitForGameClient()
	...
	warn("FarmPlotPurchaseHandler: GameClient not available after " .. maxWait .. " seconds")
	return nil
end

-- Wait for GameClient before proceeding
local GameClient = waitForGameClient()
if not GameClient then
	warn("FarmPlotPurchaseHandler: Running without GameClient integration")
	return
end

print("FarmPlotPurchaseHandler: Successfully connected to GameClient")
