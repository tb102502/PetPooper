...
local ContentFrame = shopGui:WaitForChild("ContentFrame")        -- Frame that contains the shop UI
local topBar    = shopGui:WaitForChild("TopBar")           -- Frame or Folder with the toggle button
