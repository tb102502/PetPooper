...
local contentFrame = shopGui:WaitForChild("ContentFrame", 5)
if not contentFrame then
	warn("ContentFrame not found!")
	return
end

local topBar = mainGui:WaitForChild("TopBar", 5)
local inventoryFrame = topBar:WaitForChild("InventoryFrame", 5)
