...
-- Get remote events
local OpenShop = ReplicatedStorage.RemoteEvents:WaitForChild("OpenShop")
...
local InventoryFrame = MainGui.TopBar:WaitForChild("InventoryFrame")
local ToggleButton = MainGui.TopBar:WaitForChild("ToggleButton")
...
function purchaseItem(itemData)
	...
	local PurchaseEvent = ReplicatedStorage.RemoteEvents:WaitForChild("PurchaseEvent")
	PurchaseEvent:FireServer(itemData.ID)
end

-- Connect to remote event
OpenShop.OnClientEvent:Connect(toggleShop)
